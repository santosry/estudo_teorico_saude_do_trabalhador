...
# Original: 'CARACTERIZAÇÃO - CAMPOS/script.R' -> scripts/legado/CARACTERIZACAO_script_original.R
# Auditoria: 2026-07-18 | Ver logs/log_alteracoes_scripts.csv
# ---------------------------------------------------------------------
# [B1] BAIXO    setwd() com caminho absoluto de outra pasta -> não portável.
# [B2] MODERADO 'pib_per_capita.csv' contém a tabela SIDRA 4709 (população
#      residente/variação/taxa de crescimento), NÃO PIB per capita.
#      No pipeline novo, PIB per capita foi calculado como PIB (tab. 5938)
#      dividido pela população (tab. 6579/4714), com fonte declarada.
# [B3] INFO     8 de 21 tabelas falharam no download (5939, 9518, 9519,
#      9520, 9607, 9609, 9610) -> caracterização incompleta; lacunas
#      declaradas no relatório metodológico.
# =====================================================================

setwd("C:/Users/oorie/OneDrive/Documentos/TRABALHOS/CARACTERIZA��O")
